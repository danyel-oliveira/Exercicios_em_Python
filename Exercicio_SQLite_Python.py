  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/danyel-oliveira/Exercicios_em_Python/blob/main/Exercicio_SQLite_Python.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "IasSaWLK4XSi",
        "outputId": "676f218f-0635-4973-bb6e-f138166de3ec"
      },
      "outputs": [
        {
          "output_type": "stream",
